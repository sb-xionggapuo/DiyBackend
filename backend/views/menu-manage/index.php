                    ...
                    <div class="am-btn-toolbar">
                        <div class="am-btn-group am-btn-group-xs">
                            <button type="button" class="am-btn am-btn-default am-btn-success"><span class="am-icon-plus"></span>
                                <a href="<?=\yii\helpers\Url::to(['menu-manage/add'])?>">新增</a></button>
                    ...
                    <form class="am-form">
                        <table class="am-table am-table-striped am-table-hover table-main">
                            ...
                            <tr>
                                ...
                                <td><?=$m->pid?></td>
                                <td class="am-hide-sm-only"><img style="width: 20px;height: 20px" src="<?=$m->image?>" alt="未设置图片"></td>
                                <td class="am-hide-sm-only"><?=date("Y-m-d H:i:s",$m->updated_at)?></td>
                                <td>
                                    <div class="am-btn-toolbar">
                                        <div class="am-btn-group am-btn-group-xs">
